...
<head>
    ...
    <title>Petugas - Sistem Informasi Pelaporan Puskesmas</title>
    ...
    include '../koneksi.php';
    session_start();
    if($_SESSION['status'] != "kiakb_login"){
        header("location:../petugas_login.php?alert=belum_login");
    }
    ?>
</head>
<body>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <?php } ?>
                                                <span class="admin-name"><?php echo $profil['petugas_nama']; ?> [ <b>KIA/KB</b> ]</span>
