    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="content-error">
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "gagal"){
                        echo "<div class='alert alert-danger'>LOGIN GAGAL! USERNAME, PASSWORD, DAN KAMAR SALAH!</div>";
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="periksa_petugas_login.php" method="POST" id="loginForm">
                            ...
                            <div class="form-group">
                                <label>Program</label>
                                <select class="form-control" name="kamar" placeholder="Pilih Kamar">
                                    <option></option>
                                    <option value="kiakb">KIA & KB</option>
                                    <option value="gizi">Gizi</option>
                                    <option value="promkes">Promkes</option>
                                    <option value="kesling">Kesehatan Lingkungan</option>
                                    <option value="penyakitmenular">Penyakit Menular</option>
                                    <option value="penyakittidakmenular">Penyakit Tidak Menular</option>
                                    <option value="imunisasi">Imunisasi</option>
                                    <option value="surveilance">Surveilance</option>
                                    <option value="kestra">Kesehatan Tradisional</option>
                                    <option value="kesol">Kesehatan Olahraga</option>
                                    <option value="kesker">Kesehatan Kerja</option>
                                    <option value="keslan">Kesehatan Lansia</option>
                                    <option value="uks">Upaya Kesehatan Sekolah</option>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Pelaporan Puskesmas</p>
            </div>
        </div>   
    </div>
