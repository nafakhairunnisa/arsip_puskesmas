            ...
            <div class="col-lg-3">
                ...
                <div class="single-cards-item">
                    <div class="single-product-image">
                        <a href="#">
                            <img src="../assets/img/product/profile_bg.jpeg.jpg" alt="">
                        </a>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "sukses"){
                        echo "<div class='alert alert-success'>Profil anda berhasil diganti!</div>";
                    }
                }
                ?>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="profil_act.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control" placeholder="Masukkan Email .." name="email" required="required" value="<?php echo $s['user_email'] ?>">
                            </div>
