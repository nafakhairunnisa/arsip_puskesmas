    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="content-error">
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "gagal"){
                        echo "<div class='alert alert-danger'>LOGIN GAGAL! EMAIL DAN PASSWORD SALAH!</div>";
                    }else if($_GET['alert'] == "logout"){
                        echo "<div class='alert alert-success'>ANDA TELAH BERHASIL LOGOUT</div>";
                    }else if($_GET['alert'] == "belum_login"){
                        echo "<div class='alert alert-warning'>ANDA HARUS LOGIN UNTUK MENGAKSES DASHBOARD</div>";
                    } else if($_GET['alert'] == "verify"){
                        echo "<div class='alert alert-danger'>HARAP VERIFIKASI AKUN ANDA!</div>";
                    }
                }
                    ...
                    <div class="panel-body">
                        ...
                        <form action="periksa_user_login.php" method="POST" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="email" title="Email" required="required" autocomplete="off" name="email" id="email" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="submit" class="btn btn-success btn-block loginbtn" name="login" value="Login">
                        </form>

                        <center><h5>Belum punya akun? <a href="registrasi.php">Daftar</a></h5></center>
