                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a target="_blank" class="btn btn-default" href="arsip_download_all.php?id=<?php echo $p['arsip_id']; ?>" download><i class="fa fa-download"></i></a>
                                    <a target="_blank" href="arsip_preview_all.php?id=<?php echo $p['arsip_id']; ?>" class="btn btn-default"><i class="fa fa-search"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php 
