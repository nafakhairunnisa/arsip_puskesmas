        ...
        <div class="panel-body">
            ...
            <center>
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "gagal"){
                        ?>
                        <div class="alert alert-danger">File arsip gagal diupload.</div>
                        <?php
                    }else{
                        ?>
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <?php 
                    ...
                    $arsip = mysqli_query($koneksi, "SELECT * FROM arsip
                                INNER JOIN kategori ON arsip_kategori = kategori.kategori_id
                                INNER JOIN petugas ON arsip_petugas = petugas.petugas_id
                                INNER JOIN kamar ON arsip_kamar = kamar.kamar_id
                                WHERE kamar.kamar_id = 10
                    ...
                    while($p = mysqli_fetch_array($arsip)){
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus data ini? <br>file akan dihapus secara permanen.
                                            </div>
                                ...
                                <div class="btn-group">
                                    <a target="_blank" class="btn btn-default" href="../arsip/<?php echo $p['arsip_file']; ?>" download><i class="fa fa-download"></i></a>
                                    <a target="_blank" href="arsip_preview.php?id=<?php echo $p['arsip_id']; ?>" class="btn btn-default"><i class="fa fa-search"></i></a>
